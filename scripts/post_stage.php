<?php
/*
 * The script post_stage.php will be executed after the staging process ends.
 * This will allow users to perform some actions on the source tree or server
 * before an attempt to activate the app is made. For example, this will allow
 * creating a new DB schema and modifying some file or directory permissions on
 * staged source files The following environment variables are accessable to the
 * script:
 */
